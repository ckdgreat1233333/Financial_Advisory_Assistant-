...
# Inline test scenarios matching the risk rules from models/risk.py
RISK_SCENARIOS = {
    "LOW_RISK": {
        "application": {"loan_amount": 600000, "monthly_salary": 50000},
        "extracted_data": {"monthly_salary": 50000, "average_monthly_balance": 45000, "employment_duration": "3 years"},
    },
    "HIGH_RISK_MISSING_DOCS": {
        "application": {"loan_amount": 1000000, "monthly_salary": 50000},
        "extracted_data": {"monthly_salary": 50000, "employment_duration": "3 years"},
    },
    "MEDIUM_RISK_EMPLOYMENT_CHANGE": {
        "application": {"loan_amount": 500000, "monthly_salary": 40000},
        "extracted_data": {"monthly_salary": 40000, "average_monthly_balance": 35000, "employment_duration": "8 months"},
    },
}
...
class TestOrchestrator:
    ...
    def test_complete_workflow(self):
        self.orchestrator.document_agent.process = MagicMock(return_value={
            ...
            "metadata": {
                "extracted_data": {
                    "monthly_salary": 50000, "employer": "ABC Corp",
                    "employee_name": "John", "employment_duration": "3 years"
                }
            }
        })

        self.orchestrator.policy_agent.check_compliance = MagicMock(return_value=PolicyResult(
            eligibility_status=EligibilityStatus.ELIGIBLE,
            policy_sections=[],
            violations=[],
            explanation="Compliant",
        ...
        self.orchestrator.risk_agent.evaluate = MagicMock(return_value=RiskAssessment(
...
class TestCustomerAgent:
    ...
    def test_friendly_mode_response(self):
        ...
        self.customer_agent.customer.answer.return_value = "Based on our policy, the minimum salary requirement is \u20b930,000 per month."
    ...
    def test_compliance_mode_response(self):
        self.customer_agent.customer = MagicMock()
        self.customer_agent.customer.answer.return_value = "I cannot determine the answer from the available policy documents."
